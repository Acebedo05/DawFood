...
public class Hamburguesa {
    ...
    // Constructor.
    public Hamburguesa(String id, String nombre, double precio, boolean enStock, String descripcion, String categoria, double iva, String subcategoria) {
        this.id = id;
        this.nombre = nombre;
        this.precio = precio;
    ...
    public int hashCode() {
        ...
        hash = 37 * hash + Objects.hashCode(this.subcategoria);
        return hash;
    }

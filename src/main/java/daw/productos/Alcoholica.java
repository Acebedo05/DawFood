...
public class Alcoholica {
    ...
    // Constructor.
    public Alcoholica(String id, String nombre, double precio, boolean enStock, String descripcion, String categoria, double iva, String subcategoria) {
        this.id = id;
        this.nombre = nombre;
        this.precio = precio;
    ...
    public int hashCode() {
        ...
        hash = 17 * hash + Objects.hashCode(this.subcategoria);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Alcoholica other = (Alcoholica) obj;

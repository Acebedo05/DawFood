...
public class Pizza {
    ...
    // Constructor.
    public Pizza(String id, String nombre, double precio, boolean enStock, String descripcion, String categoria, double iva, String subcategoria) {
        this.id = id;
        this.nombre = nombre;
        this.precio = precio;
    ...
    public int hashCode() {
        ...
        hash = 71 * hash + (this.enStock ? 1 : 0);
        hash = 71 * hash + Objects.hashCode(this.descripcion);
        hash = 71 * hash + Objects.hashCode(this.categoria);
        hash = 71 * hash + (int) (Double.doubleToLongBits(this.iva) ^ (Double.doubleToLongBits(this.iva) >>> 32));
        hash = 71 * hash + Objects.hashCode(this.subcategoria);
        return hash;
    }
